...
|-------------------------------|------------------|-------------------|
| **Стовпець**                  | **Тип даних**    | **Опис**          | 
| ArchiveID (int, PK)           | int              | Унікальний ідентифікатор архівного запису. |
| Timestamp (timestamp)         | timestamp        | Часова мітка архіву. |
| UserID (int)                  | int              | Ідентифікатор користувача, який здійснив архівацію. |
| ObjectType (varchar)          | varchar          | Тип об'єкта, який був архівований. |
| ObjectID (int)                | int              | Ідентифікатор об'єкта, який був архівований. |
| Status (varchar)              | varchar          | Статус архіву. |
